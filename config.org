...
; line numbers
;; TODO change to only in org mode
...
;; https://hieuphay.com/doom-emacs-config/#some-good-defaults
...
;;   (custom-set-faces
;;    '(mode-line ((t (:background "#3c3836"))))
;;    '(mode-line-active ((t (:background "#3c3836"))))))  ; other bg: #282828
#+end_src
*** zen
#+begin_src emacs-lisp
