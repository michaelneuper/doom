...
Highlight doxygen comments in =c-mode=.
#+begin_src emacs-lisp
(use-package! highlight-doxygen
  :hook (c-mode . highlight-doxygen-global-mode)
  :config
  (custom-set-faces!
...
Integrate with the mac calendar.
There is currently a bug in the code, until my PR is merged,
the following patch has to be applied:
https://github.com/haji-ali/maccalfw/pull/4/commits/fcbc3f30b919bc6a21e33d99a407e92758527db3
#+begin_src emacs-lisp
(use-package! maccalfw
  :if (featurep :system 'macos)
  :after calfw-blocks
  :commands (maccalfw-open my/maccalfw-open-selective my/maccalfw-open-assessments)
  :init
